...
public class GaussianFilter extends ConvolveFilter {
	...
	/**
	 * Set the radius of the kernel, and hence the amount of blur. The bigger the radius,
	 * the longer this filter will take.
	...
	public BufferedImage filter(BufferedImage src, BufferedImage dst) {
		...
		if (this.radius > 0) {
			convolveAndTranspose(this.kernel, inPixels, outPixels, width, height, alpha, alpha && premultiplyAlpha, false,
					CLAMP_EDGES);
			convolveAndTranspose(this.kernel, outPixels, inPixels, height, width, alpha, false, alpha && premultiplyAlpha,
					CLAMP_EDGES);
		}
	 ...
	 * @param premultiply add TODO
	 * @param unpremultiply add TODO
