...
public class ImageMath {
	 ...
	 * @param b the bias parameter. 0.5 means no change, smaller values bias towards 0,
	 * larger towards 1.
	...
	public static float gain(float a, float b) {
		 ...
		 * (float)Math.pow(2 * a, p) / 2; else return 1.0f - (float)Math.pow(2 * (1. - a),
		 * p) / 2;
		 */
	...
	/**
	 * A smoothed step function. A cubic function is used to smooth the step between two
	 * thresholds.
	 * @param a the lower threshold position
	 * @param b the upper threshold position
	 * @param x the input parameter
	...
	/**
	 * A "circle up" function. Returns y on a unit circle given 1-x. Useful for forming
	 * bevels.
	...
	/**
	 * A "circle down" function. Returns 1-y on a unit circle given x. Useful for forming
	 * bevels.
	 * @param x the input parameter in the range 0..1
	 * @return the output value
	 */
	 ...
	 * @param p the number to premultiply
	 * @param offset the offset that will be added to the length
	...
	/**
	 * Un-Premultiply a block of pixels.
	 * @param p the number to premultiply
	 * @param offset the offset that will be added to the length
	 * @param length the length
	 */
