...
/**
 * Some more useful math functions for image processing. These are becoming obsolete as we
 * move to Java2D. Use MiscComposite instead.
...
public class PixelUtils {
	...
	/**
	 * The ALPHA_TO_GRAY ALPHA_TO_GRAY constant.
	 */
